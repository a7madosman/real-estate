...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+12 3455 6975")
    ...
    country = CountryField(verbose_name=_("Country"), default="USA", blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Your city name", blank=False, null=False)
    is_buyer = models.BooleanField(verbose_name=_("Buyer"), default=False, help_text="Are you looking to buy a "
                                                                                     "property ?")
    is_seller = models.BooleanField(verbose_name=_("Seller"), default=False, help_text="Are you looking to sell a "
                                                                                       "property ?")
