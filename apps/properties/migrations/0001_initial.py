# Generated by Django 3.2.7 on 2022-05-05 13:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Default descriptoin ... Update me please ...', verbose_name='Description')),
                ('country', django_countries.fields.CountryField(default='US', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='NY', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='140', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='Street No1', max_length=150, verbose_name='Street Address')),
                ...
                ('tax', models.DecimalField(decimal_places=2, default=0.15, help_text='15% property tax charge', max_digits=6, verbose_name='Tax')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='propert_views', to='properties.property')),
            ],
            options={
